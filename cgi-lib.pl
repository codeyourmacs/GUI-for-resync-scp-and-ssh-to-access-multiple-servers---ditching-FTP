...
$cgi_lib'maxdata    = 10240000;    # maximum bytes to accept via POST - 2^17
$cgi_lib'writefiles =      '/htdocs/users/c01059/markspb/whitenightdate.com/temp';    # directory to which to write files, or
